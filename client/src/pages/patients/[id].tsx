...
export default function PatientDetailsPage({ id }: PatientDetailsPageProps) {
  ...
  const isLoading =
    isLoadingPatient || isLoadingAppointments || isLoadingEvolutions;
              ...
              <Card>
                ...
                <CardContent>
                  {evolutions && evolutions.length > 0 ? (
                          ...
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center">
                              ...
                              <h3 className="font-medium">
                                Atendimento em {formatDate(evolution.createdAt)}
                              </h3>
                            </div>
                    ...
                    <div className="text-center py-8">
                      <p className="text-gray-500">
                        Este paciente ainda não possui registros de atendimento.
                      </p>
                    </div>
                  )}
                </CardContent>
